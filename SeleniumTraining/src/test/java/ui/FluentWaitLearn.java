...
public class FluentWaitLearn {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(5))
				.withMessage("THis is custom message").pollingEvery(Duration.ofSeconds(2))
				.ignoring(NoSuchElementException.class);

		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("/html/body/div[7]/div[1]/div/div[1]/ul/li[3]/div[2]/div[1]/nav[2]/ul/li[1]/a"))).click();
